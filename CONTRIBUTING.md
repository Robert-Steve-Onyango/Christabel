# Contribution Guidelines [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/smaranjitghose/awesome-experience-websites/issues):
...
**1.**  Fork [this](https://github.com/smaranjitghose/awesome-experience-websites) repository.
...
```
git clone --depth 1 https://github.com/<your_user_name>/awesome-experience-websites.git
```
...
```
cd awesome-experience-websites
```

**4.** Add a reference to the original repository.

```
git remote add upstream https://github.com/smaranjitghose/awesome-experience-websites.git 
```
...
- Comment on any existing [issue(s)](https://github.com/smaranjitghose/awesome-experience-websites/issues) raised by **project maintainers**. Otherwise raise a [new issue](https://github.com/smaranjitghose/awesome-experience-websites/issues/new).
...
**9.** Voila :exclamation: You have made a PR to the awesome-developer-experience project :boom: . Sit back patiently and relax while the project maintainers review your PR. Please understand at times the time can vary from a few hours to a few days.
